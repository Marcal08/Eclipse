...
public class ProdutoService {
	...
	private final int FORM_ORDERBY_salario = 3;
	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		if(tipo != FORM_INSERT) {
			...
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;<a href=\"/produto/list/1\">Novo Piloto</a></b></font></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";
			umProduto += "\t<br>";			
		}
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			if (tipo == FORM_INSERT){
				...
				name = "Atualizar Piloto (ID " + produto.getID() + ")";
			...
			umProduto += "\t\t\t<td>Salario: <input class=\"input--register\" type=\"text\" name=\"salario\" value=\""+ produto.getsalario() +"\"></td>";
			umProduto += "\t\t\t<td>Idade: <input class=\"input--register\" type=\"text\" name=\"idade\" value=\""+ produto.getidade() +"\"></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de Ingresso: <input class=\"input--register\" type=\"text\" name=\"dataingresso\" value=\""+ produto.getdataingresso().toString() + "\"></td>";
			umProduto += "\t\t\t<td>Data de aposentadoria: <input class=\"input--register\" type=\"text\" name=\"dataaposentadoria\" value=\""+ produto.getdataaposentadoria().toString() + "\"></td>";
			...
			umProduto += "\t<table width=\"80%\" bgcolor=\"#f3f3f3\" align=\"center\">";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td colspan=\"3\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Detalhar Piloto (ID " + produto.getID() + ")</b></font></td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td colspan=\"3\" align=\"left\">&nbsp;</td>";
			umProduto += "\t\t</tr>";
			...
			umProduto += "\t\t\t<td>Salario: "+ produto.getsalario() +"</td>";
			umProduto += "\t\t\t<td>Idade: "+ produto.getidade() +"</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de ingresso: "+ produto.getdataingresso().toString() + "</td>";
			umProduto += "\t\t\t<td>Data de aposentadoria: "+ produto.getdataaposentadoria().toString() + "</td>";
			umProduto += "\t\t\t<td>&nbsp;</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";		
		} else {
		...
		list += "\n<tr><td colspan=\"6\" align=\"left\"><font size=\"+2\"><b>&nbsp;&nbsp;&nbsp;Relação de Pilotos</b></font></td></tr>\n" +
				"\n<tr><td colspan=\"6\">&nbsp;</td></tr>\n" +
    			"\n<tr>\n" + 
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_ID + "\"><b>ID</b></a></td>\n" +
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_nome + "\"><b>Nome</b></a></td>\n" +
        		"\t<td><a href=\"/produto/list/" + FORM_ORDERBY_salario + "\"><b>Salario</b></a></td>\n" +
		...
		} else if (orderBy == FORM_ORDERBY_salario) {			produtos = produtoDAO.getOrderBysalario();
		...
		for (Produto p : produtos) {
			...
			list += "\n<tr bgcolor=\""+ bgcolor +"\">\n" + 
            		  ...
            		  "\t<td align=\"center\" valign=\"middle\"><a href=\"javascript:confirmarDeleteProduto('" + p.getID() + "', '" + p.getnome() + "', '" + p.getsalario() + "');\"><img src=\"/image/delete.png\" width=\"20\" height=\"20\"/></a></td>\n" +
            		  "</tr>\n";
		}
		list += "</table>";		
	...
	public Object insert(Request request, Response response) {
		...
		LocalDateTime dataingresso = LocalDateTime.parse(request.queryParams("dataingresso"));
		LocalDate dataaposentadoria = LocalDate.parse(request.queryParams("dataaposentadoria"));
		
		String resp = "";
		
		Produto produto = new Produto(-1, nome, salario, idade, dataingresso, dataaposentadoria);
	...
	public Object update(Request request, Response response) {
        ...
        if (produto != null) {
        	...
        	produto.setsalario(Float.parseFloat(request.queryParams("salario")));
        	produto.setidade(Integer.parseInt(request.queryParams("idade")));
        	produto.setdataingresso(LocalDateTime.parse(request.queryParams("dataingresso")));
        	produto.setdataaposentadoria(LocalDate.parse(request.queryParams("dataaposentadoria")));
	...
	public Object delete(Request request, Response response) {
        ...
        if (produto != null) {
            ...
            response.status(200); // success
            resp = "Piloto (" + id + ") excluído!";
        } else {
            response.status(404); // 404 Not found
            resp = "Piloto (" + id + ") não encontrado!";
        }
		makeForm();
		return form.replaceFirst("<input type=\"hidden\" id=\"msg\" name=\"msg\" value=\"\">", "<input type=\"hidden\" id=\"msg\" name=\"msg\" value=\""+ resp +"\">");
	}
